...
namespace Global
{
    internal class global
    {
        ...
        public static string[] credits = { "   _____                                 _  __          __             _                ", @"  / ____|                               (_) \ \        / /            (_)               ", @" | (___   __ _ _ __ ___  _   _ _ __ __ _ _   \ \  /\  / /_ _ _ __ _ __ _  ___  _ __ ___ ", @"  \___ \ / _` | '_ ` _ \| | | | '__/ _` | |   \ \/  \/ / _` | '__| '__| |/ _ \| '__/ __|", @"  ____) | (_| | | | | | | |_| | | | (_| | |    \  /\  / (_| | |  | |  | | (_) | |  \__ \", @" |_____/ \__,_|_| |_| |_|\__,_|_|  \__,_|_|     \/  \/ \__,_|_|  |_|  |_|\___/|_|  |___/", "", "", "", "", "", "Programmed By: Ben King & Trevor Lory", "", "Story by: Trevor Lory", "", "Level Design By???: Trevor Lory", "", "Engine Developed By: Physlihght Developments", "", "Special Thanks to: tomakita for Colorful Console", "", "Product Design by: Damin \'the man\' Lake", "", "Bananas Provided By: Los Monos" };
